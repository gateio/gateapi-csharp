...
**CreateTimeMs** | **long** | Order creation time in milliseconds | [optional] [readonly] 
**UpdateTimeMs** | **long** | Order last modification time in milliseconds | [optional] [readonly] 
