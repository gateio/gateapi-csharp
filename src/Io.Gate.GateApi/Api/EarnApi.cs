...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IEarnApiSync : IApiAccessor
    {
        ...
        /// <param name="swapCoin"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> SwapStakingCoinWithHttpInfo (SwapCoin swapCoin);
    ...
    public interface IEarnApiAsync : IApiAccessor
    {
        ...
        /// <param name="swapCoin"></param>
        /// <returns>Task of void</returns>
        Task SwapStakingCoinAsync (SwapCoin swapCoin);
        ...
        /// <param name="swapCoin"></param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<Object>> SwapStakingCoinAsyncWithHttpInfo (SwapCoin swapCoin);
    ...
    public partial class EarnApi : IEarnApi
    {
        ...
        /// <param name="swapCoin"></param>
        /// <returns></returns>
        public void SwapStakingCoin (SwapCoin swapCoin)
        {
        ...
        /// <param name="swapCoin"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> SwapStakingCoinWithHttpInfo (SwapCoin swapCoin)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/earn/staking/swap", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="swapCoin"></param>
        /// <returns>Task of void</returns>
        public async Task SwapStakingCoinAsync (SwapCoin swapCoin)
        {
             await SwapStakingCoinAsyncWithHttpInfo(swapCoin);
        ...
        /// <param name="swapCoin"></param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> SwapStakingCoinAsyncWithHttpInfo (SwapCoin swapCoin)
        {
            // verify the required parameter 'swapCoin' is set
            if (swapCoin == null)
                throw new ApiException(400, "Missing required parameter 'swapCoin' when calling EarnApi->SwapStakingCoin");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/earn/staking/swap", localVarRequestOptions, this.Configuration);
