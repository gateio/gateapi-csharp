...
namespace Io.Gate.GateApi.Api
{
    ...
    public interface IEarnApiSync : IApiAccessor
    {
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> CancelDualOrderWithHttpInfo (int orderId);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="structuredGetProjectListRequest"></param>
        ...
        ApiResponse<List<StructuredGetProjectList>> ListStructuredProductsWithHttpInfo (StructuredGetProjectListRequest structuredGetProjectListRequest);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Io.Gate.GateApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="structuredOrderListRequest"></param>
        ...
        ApiResponse<List<StructuredOrderList>> ListStructuredOrdersWithHttpInfo (StructuredOrderListRequest structuredOrderListRequest);
        /// <summary>
    ...
    public interface IEarnApiAsync : IApiAccessor
    {
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns>Task of void</returns>
        Task CancelDualOrderAsync (int orderId);
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns>Task of ApiResponse</returns>
        Task<ApiResponse<Object>> CancelDualOrderAsyncWithHttpInfo (int orderId);
        /// <summary>
        /// Structured Product List
        /// </summary>
        /// <remarks>
        ...
        Task<List<StructuredGetProjectList>> ListStructuredProductsAsync (StructuredGetProjectListRequest structuredGetProjectListRequest);
        ...
        Task<ApiResponse<List<StructuredGetProjectList>>> ListStructuredProductsAsyncWithHttpInfo (StructuredGetProjectListRequest structuredGetProjectListRequest);
        /// <summary>
        /// Structured Product Order List
        /// </summary>
        /// <remarks>
        ...
        Task<List<StructuredOrderList>> ListStructuredOrdersAsync (StructuredOrderListRequest structuredOrderListRequest);
        ...
        Task<ApiResponse<List<StructuredOrderList>>> ListStructuredOrdersAsyncWithHttpInfo (StructuredOrderListRequest structuredOrderListRequest);
        /// <summary>
        /// Place Structured Product Order
        /// </summary>
        /// <remarks>
    ...
    public partial class EarnApi : IEarnApi
    {
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns></returns>
        public void CancelDualOrder (int orderId)
        {
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> CancelDualOrderWithHttpInfo (int orderId)
        {
            RequestOptions localVarRequestOptions = new RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/earn/dual/orders/{order_id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CancelDualOrder", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns>Task of void</returns>
        public async Task CancelDualOrderAsync (int orderId)
        {
             await CancelDualOrderAsyncWithHttpInfo(orderId);
        ...
        /// <param name="orderId">Order ID</param>
        /// <returns>Task of ApiResponse</returns>
        public async Task<ApiResponse<Object>> CancelDualOrderAsyncWithHttpInfo (int orderId)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/earn/dual/orders/{order_id}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="structuredGetProjectListRequest"></param>
        /// <returns>List&lt;StructuredGetProjectList&gt;</returns>
        public List<StructuredGetProjectList> ListStructuredProducts (StructuredGetProjectListRequest structuredGetProjectListRequest)
        {
             ApiResponse<List<StructuredGetProjectList>> localVarResponse = ListStructuredProductsWithHttpInfo(structuredGetProjectListRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="structuredGetProjectListRequest"></param>
        /// <returns>ApiResponse of List&lt;StructuredGetProjectList&gt;</returns>
        public ApiResponse<List<StructuredGetProjectList>> ListStructuredProductsWithHttpInfo (StructuredGetProjectListRequest structuredGetProjectListRequest)
        {
            // verify the required parameter 'structuredGetProjectListRequest' is set
            if (structuredGetProjectListRequest == null)
                throw new ApiException(400, "Missing required parameter 'structuredGetProjectListRequest' when calling EarnApi->ListStructuredProducts");
            ...
            localVarRequestOptions.Data = structuredGetProjectListRequest;
        ...
        /// <param name="structuredGetProjectListRequest"></param>
        /// <returns>Task of List&lt;StructuredGetProjectList&gt;</returns>
        public async Task<List<StructuredGetProjectList>> ListStructuredProductsAsync (StructuredGetProjectListRequest structuredGetProjectListRequest)
        {
             Io.Gate.GateApi.Client.ApiResponse<List<StructuredGetProjectList>> localVarResponse = await ListStructuredProductsAsyncWithHttpInfo(structuredGetProjectListRequest);
             return localVarResponse.Data;
        ...
        /// <param name="structuredGetProjectListRequest"></param>
        /// <returns>Task of ApiResponse (List&lt;StructuredGetProjectList&gt;)</returns>
        public async Task<ApiResponse<List<StructuredGetProjectList>>> ListStructuredProductsAsyncWithHttpInfo (StructuredGetProjectListRequest structuredGetProjectListRequest)
        {
            // verify the required parameter 'structuredGetProjectListRequest' is set
            if (structuredGetProjectListRequest == null)
                throw new ApiException(400, "Missing required parameter 'structuredGetProjectListRequest' when calling EarnApi->ListStructuredProducts");
        ...
        /// <param name="structuredOrderListRequest"></param>
        /// <returns>List&lt;StructuredOrderList&gt;</returns>
        public List<StructuredOrderList> ListStructuredOrders (StructuredOrderListRequest structuredOrderListRequest)
        {
             ApiResponse<List<StructuredOrderList>> localVarResponse = ListStructuredOrdersWithHttpInfo(structuredOrderListRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="structuredOrderListRequest"></param>
        /// <returns>ApiResponse of List&lt;StructuredOrderList&gt;</returns>
        public ApiResponse<List<StructuredOrderList>> ListStructuredOrdersWithHttpInfo (StructuredOrderListRequest structuredOrderListRequest)
        {
            // verify the required parameter 'structuredOrderListRequest' is set
            if (structuredOrderListRequest == null)
                throw new ApiException(400, "Missing required parameter 'structuredOrderListRequest' when calling EarnApi->ListStructuredOrders");
            ...
            localVarRequestOptions.Data = structuredOrderListRequest;
        ...
        /// <param name="structuredOrderListRequest"></param>
        /// <returns>Task of List&lt;StructuredOrderList&gt;</returns>
        public async Task<List<StructuredOrderList>> ListStructuredOrdersAsync (StructuredOrderListRequest structuredOrderListRequest)
        {
             Io.Gate.GateApi.Client.ApiResponse<List<StructuredOrderList>> localVarResponse = await ListStructuredOrdersAsyncWithHttpInfo(structuredOrderListRequest);
             return localVarResponse.Data;
        ...
        /// <param name="structuredOrderListRequest"></param>
        /// <returns>Task of ApiResponse (List&lt;StructuredOrderList&gt;)</returns>
        public async Task<ApiResponse<List<StructuredOrderList>>> ListStructuredOrdersAsyncWithHttpInfo (StructuredOrderListRequest structuredOrderListRequest)
        {
            // verify the required parameter 'structuredOrderListRequest' is set
            if (structuredOrderListRequest == null)
                throw new ApiException(400, "Missing required parameter 'structuredOrderListRequest' when calling EarnApi->ListStructuredOrders");
