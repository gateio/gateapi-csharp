...
namespace Io.Gate.GateApi.Api
{
    ...
    public partial class SubAccountApi : ISubAccountApi
    {
        ...
        {
             ApiResponse<SubAccountKey> localVarResponse = CreateSubAccountKeysWithHttpInfo(userId, subAccountKey);
             return localVarResponse.Data;
        }
        ...
        public ApiResponse<SubAccountKey> CreateSubAccountKeysWithHttpInfo (long userId, SubAccountKey subAccountKey)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<SubAccountKey>("/sub_accounts/{user_id}/keys", localVarRequestOptions, this.Configuration);
        ...
        {
             Io.Gate.GateApi.Client.ApiResponse<SubAccountKey> localVarResponse = await CreateSubAccountKeysAsyncWithHttpInfo(userId, subAccountKey);
             return localVarResponse.Data;
        ...
        public async Task<ApiResponse<SubAccountKey>> CreateSubAccountKeysAsyncWithHttpInfo (long userId, SubAccountKey subAccountKey)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<SubAccountKey>("/sub_accounts/{user_id}/keys", localVarRequestOptions, this.Configuration);
