...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CrossMarginBalance1 :  IEquatable<CrossMarginBalance1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossMarginBalance1" /> class.
        /// </summary>
        ...
        public CrossMarginBalance1(string available = default(string), string freeze = default(string), string borrowed = default(string), string interest = default(string))
        {
        ...
        {
            return this.Equals(input as CrossMarginBalance1);
        }

        /// <summary>
        /// Returns true if CrossMarginBalance1 instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossMarginBalance1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossMarginBalance1 input)
        {
            if (input == null)
                return false;
