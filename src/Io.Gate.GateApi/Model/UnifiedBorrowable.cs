...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class UnifiedBorrowable :  IEquatable<UnifiedBorrowable>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UnifiedBorrowable);
        }

        /// <summary>
        /// Returns true if UnifiedBorrowable instances are equal
        /// </summary>
        /// <param name="input">Instance of UnifiedBorrowable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnifiedBorrowable input)
        {
            if (input == null)
                return false;
