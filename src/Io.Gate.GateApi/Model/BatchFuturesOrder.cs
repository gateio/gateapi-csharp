...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BatchFuturesOrder :  IEquatable<BatchFuturesOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchFuturesOrder" /> class.
        /// </summary>
        /// <param name="succeeded">Whether the batch of orders succeeded.</param>
        /// <param name="label">Error label, only exists if execution fails.</param>
        /// <param name="detail">Error detail, only present if execution failed and details need to be given.</param>
        ...
        public BatchFuturesOrder(bool succeeded = default(bool), string label = default(string), string detail = default(string), string contract = default(string), long size = default(long), long iceberg = default(long), string price = default(string), bool close = false, bool reduceOnly = false, TifEnum? tif = TifEnum.Gtc, string text = default(string), AutoSizeEnum? autoSize = default(AutoSizeEnum?))
        {
        ...
        /// </summary>
        /// <value>Error label, only exists if execution fails</value>
        ...
        /// </summary>
        /// <value>Error detail, only present if execution failed and details need to be given</value>
        ...
        {
            return this.Equals(input as BatchFuturesOrder);
        }

        /// <summary>
        /// Returns true if BatchFuturesOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchFuturesOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchFuturesOrder input)
        {
            if (input == null)
                return false;
