...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class MyFuturesTradeTimeRange :  IEquatable<MyFuturesTradeTimeRange>, IValidatableObject
    {
        ...
        public MyFuturesTradeTimeRange(string tradeId = default(string), double createTime = default(double), string contract = default(string), string orderId = default(string), long size = default(long), string price = default(string), RoleEnum? role = default(RoleEnum?), string text = default(string), string fee = default(string), string pointFee = default(string))
        {
