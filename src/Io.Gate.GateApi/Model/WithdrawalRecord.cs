...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class WithdrawalRecord :  IEquatable<WithdrawalRecord>, IValidatableObject
    {
        ...
        public WithdrawalRecord(string withdrawOrderId = default(string), string amount = default(string), string currency = default(string), string failReason = default(string), string timestamp2 = default(string), string memo = default(string), string chain = default(string))
        {
