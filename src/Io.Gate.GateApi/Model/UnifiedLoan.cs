...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class UnifiedLoan :  IEquatable<UnifiedLoan>, IValidatableObject
    {
        ...
        public UnifiedLoan(string currency = default(string), TypeEnum type = default(TypeEnum), string amount = default(string), bool repaidAll = default(bool), string text = default(string))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency", "currency is a required property for UnifiedLoan and cannot be null");
            this.Type = type;
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount", "amount is a required property for UnifiedLoan and cannot be null");
        ...
        /// </summary>
        /// <value>Full repayment is solely for repayment operations. When set to &#39;true,&#39; it overrides the &#39;amount,&#39; allowing for direct full repayment.</value>
        ...
        {
            return this.Equals(input as UnifiedLoan);
        }

        /// <summary>
        /// Returns true if UnifiedLoan instances are equal
        /// </summary>
        /// <param name="input">Instance of UnifiedLoan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnifiedLoan input)
        {
            if (input == null)
                return false;
