...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class OptionsPositionCloseOrder :  IEquatable<OptionsPositionCloseOrder>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OptionsPositionCloseOrder);
        }

        /// <summary>
        /// Returns true if OptionsPositionCloseOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionsPositionCloseOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionsPositionCloseOrder input)
        {
            if (input == null)
                return false;
