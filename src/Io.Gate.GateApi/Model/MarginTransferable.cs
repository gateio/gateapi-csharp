...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MarginTransferable :  IEquatable<MarginTransferable>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MarginTransferable);
        }

        /// <summary>
        /// Returns true if MarginTransferable instances are equal
        /// </summary>
        /// <param name="input">Instance of MarginTransferable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarginTransferable input)
        {
            if (input == null)
                return false;
