...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfolioMarginBalance :  IEquatable<PortfolioMarginBalance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioMarginBalance" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PortfolioMarginBalance);
        }

        /// <summary>
        /// Returns true if PortfolioMarginBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioMarginBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioMarginBalance input)
        {
            if (input == null)
                return false;
