...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubAccountFuturesBalance :  IEquatable<SubAccountFuturesBalance>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SubAccountFuturesBalance);
        }

        /// <summary>
        /// Returns true if SubAccountFuturesBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of SubAccountFuturesBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubAccountFuturesBalance input)
        {
            if (input == null)
                return false;
