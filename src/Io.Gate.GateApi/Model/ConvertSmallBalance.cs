...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class ConvertSmallBalance :  IEquatable<ConvertSmallBalance>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ConvertSmallBalance);
        }

        /// <summary>
        /// Returns true if ConvertSmallBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertSmallBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertSmallBalance input)
        {
            if (input == null)
                return false;
