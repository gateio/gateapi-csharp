...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfolioAccount :  IEquatable<PortfolioAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioAccount" /> class.
        /// </summary>
        ...
        /// <param name="total">Total account value in USDT, i.e., the sum of all currencies&#39;.</param>
        /// <param name="borrowed">Total borrowed value in USDT, i.e., the sum of all currencies.</param>
        /// <param name="interest">Total unpaid interests in USDT, i.e., the sum of all currencies.</param>
        ...
        /// <param name="portfolioMarginTotal">Total margin balance of the account.</param>
        /// <param name="portfolioMarginTotalLiab">Total liabilities of the account.</param>
        /// <param name="portfolioMarginTotalEquity">Total equity of the account.</param>
        public PortfolioAccount(long userId = default(long), long refreshTime = default(long), bool locked = default(bool), Dictionary<string, PortfolioMarginBalance> balances = default(Dictionary<string, PortfolioMarginBalance>), string total = default(string), string borrowed = default(string), string interest = default(string), string totalInitialMargin = default(string), string totalMarginBalance = default(string), string totalMaintenanceMargin = default(string), string totalInitialMarginRate = default(string), string totalMaintenanceMarginRate = default(string), string totalAvailableMargin = default(string), string portfolioMarginTotal = default(string), string portfolioMarginTotalLiab = default(string), string portfolioMarginTotalEquity = default(string))
        {
            this.UserId = userId;
        ...
        public Dictionary<string, PortfolioMarginBalance> Balances { get; set; }

        /// <summary>
        /// Total account value in USDT, i.e., the sum of all currencies&#39;
        /// </summary>
        /// <value>Total account value in USDT, i.e., the sum of all currencies&#39;</value>
        ...
        /// </summary>
        /// <value>Total borrowed value in USDT, i.e., the sum of all currencies</value>
        ...
        /// </summary>
        /// <value>Total unpaid interests in USDT, i.e., the sum of all currencies</value>
        ...
        /// </summary>
        /// <value>Total margin balance of the account</value>
        ...
        /// </summary>
        /// <value>Total liabilities of the account</value>
        ...
        /// </summary>
        /// <value>Total equity of the account</value>
        ...
        {
            return this.Equals(input as PortfolioAccount);
        }

        /// <summary>
        /// Returns true if PortfolioAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioAccount input)
        {
            if (input == null)
                return false;
