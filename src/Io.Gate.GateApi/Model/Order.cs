...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(string text = default(string), string currencyPair = default(string), TypeEnum? type = TypeEnum.Limit, string account = "spot", SideEnum side = default(SideEnum), string amount = default(string), string price = default(string), TimeInForceEnum? timeInForce = TimeInForceEnum.Gtc, string iceberg = default(string), bool autoBorrow = default(bool), bool autoRepay = default(bool), StpActEnum? stpAct = default(StpActEnum?))
        {
