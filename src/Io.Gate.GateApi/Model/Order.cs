...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Account type, spot - spot account, margin - margin account, cross_margin - cross margin account, portfolio - portfolio account  Portfolio margin account must set to &#x60;cross_margin&#x60;</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="account">Account type, spot - spot account, margin - margin account, cross_margin - cross margin account, portfolio - portfolio account  Portfolio margin account must set to &#x60;cross_margin&#x60; (default to AccountEnum.Spot).</param>
