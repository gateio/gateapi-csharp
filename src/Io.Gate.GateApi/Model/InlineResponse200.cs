...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(long time = default(long), string vaule = default(string))
        {
            this.Time = time;
            this.Vaule = vaule;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Vaule: ").Append(Vaule).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse200 input)
        {
            ...
            return 
                ...
                (
                    this.Vaule == input.Vaule ||
                    (this.Vaule != null &&
                    this.Vaule.Equals(input.Vaule))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Vaule != null)
                    hashCode = hashCode * 59 + this.Vaule.GetHashCode();
                return hashCode;
            }
        }
