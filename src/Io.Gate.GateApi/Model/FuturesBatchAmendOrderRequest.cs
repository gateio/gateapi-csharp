...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FuturesBatchAmendOrderRequest :  IEquatable<FuturesBatchAmendOrderRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FuturesBatchAmendOrderRequest" /> class.
        /// </summary>
        ...
        public FuturesBatchAmendOrderRequest(long orderId = default(long), string text = default(string), long size = default(long), string price = default(string), string amendText = default(string))
        {
        ...
        {
            return this.Equals(input as FuturesBatchAmendOrderRequest);
        }

        /// <summary>
        /// Returns true if FuturesBatchAmendOrderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of FuturesBatchAmendOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FuturesBatchAmendOrderRequest input)
        {
            if (input == null)
                return false;
