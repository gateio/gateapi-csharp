...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OptionsMMPReset :  IEquatable<OptionsMMPReset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsMMPReset" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptionsMMPReset() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionsMMPReset" /> class.
        /// </summary>
        ...
        public OptionsMMPReset(string underlying = default(string))
        {
            ...
            this.Underlying = underlying ?? throw new ArgumentNullException("underlying", "underlying is a required property for OptionsMMPReset and cannot be null");
        }
        ...
        [DataMember(Name="frozen_period", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as OptionsMMPReset);
        }

        /// <summary>
        /// Returns true if OptionsMMPReset instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionsMMPReset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionsMMPReset input)
        {
            if (input == null)
                return false;
