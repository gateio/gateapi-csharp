...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class CollateralAdjustRes :  IEquatable<CollateralAdjustRes>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CollateralAdjustRes);
        }

        /// <summary>
        /// Returns true if CollateralAdjustRes instances are equal
        /// </summary>
        /// <param name="input">Instance of CollateralAdjustRes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollateralAdjustRes input)
        {
            if (input == null)
                return false;
