...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpotAccountBook :  IEquatable<SpotAccountBook>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SpotAccountBook);
        }

        /// <summary>
        /// Returns true if SpotAccountBook instances are equal
        /// </summary>
        /// <param name="input">Instance of SpotAccountBook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpotAccountBook input)
        {
            if (input == null)
                return false;
