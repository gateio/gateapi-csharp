...
namespace Io.Gate.GateApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfolioLoanRecord :  IEquatable<PortfolioLoanRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortfolioLoanRecord" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PortfolioLoanRecord()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PortfolioLoanRecord {\n");
        ...
        {
            return this.Equals(input as PortfolioLoanRecord);
        }

        /// <summary>
        /// Returns true if PortfolioLoanRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of PortfolioLoanRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortfolioLoanRecord input)
        {
            if (input == null)
                return false;
