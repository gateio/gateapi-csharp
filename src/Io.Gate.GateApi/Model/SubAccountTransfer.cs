...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class SubAccountTransfer :  IEquatable<SubAccountTransfer>, IValidatableObject
    {
        ...
        public SubAccountTransfer(string currency = default(string), string subAccount = default(string), DirectionEnum direction = default(DirectionEnum), string amount = default(string))
        {
