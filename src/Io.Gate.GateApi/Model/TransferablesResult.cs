...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class TransferablesResult :  IEquatable<TransferablesResult>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferablesResult {\n");
        ...
        {
            return this.Equals(input as TransferablesResult);
        }

        /// <summary>
        /// Returns true if TransferablesResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferablesResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferablesResult input)
        {
            if (input == null)
                return false;
