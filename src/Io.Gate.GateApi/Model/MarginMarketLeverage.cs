...
namespace Io.Gate.GateApi.Model
{
    ...
    public partial class MarginMarketLeverage :  IEquatable<MarginMarketLeverage>, IValidatableObject
    {
        ...
        protected MarginMarketLeverage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarginMarketLeverage" /> class.
        /// </summary>
        ...
        public MarginMarketLeverage(string currencyPair = default(string), string leverage = default(string))
        {
            ...
            this.Leverage = leverage ?? throw new ArgumentNullException("leverage", "leverage is a required property for MarginMarketLeverage and cannot be null");
        ...
        {
            return this.Equals(input as MarginMarketLeverage);
        }

        /// <summary>
        /// Returns true if MarginMarketLeverage instances are equal
        /// </summary>
        /// <param name="input">Instance of MarginMarketLeverage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarginMarketLeverage input)
        {
            if (input == null)
                return false;
